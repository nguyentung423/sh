...
export const metadata: Metadata = {
  ...
  description:
    "Cân Mọi Deadline - Chấp Hết Bài Tập. Gemini 3.1 Pro, Veo Video, 2TB Storage, Meet Premium trong 1 gói. Chỉ 70k/tháng cho sinh viên.",
  keywords:
  ...
  openGraph: {
    ...
    description:
      "6 tính năng AI Pro trong 1 gói. Giá gốc 475k → Giá Shop chỉ 70k/tháng.",
    type: "website",
    locale: "vi_VN",
