...
export const SEO_FAQS: SeoFaq[] = [
  ...
  {
    question: "Shop có hỗ trợ sau khi mua không?",
    answer:
      "Có. PremiumShop hỗ trợ 24/7 qua Zalo và có chính sách bảo hành 1 đổi 1 trong thời gian sử dụng theo điều kiện áp dụng.",
  },
];
